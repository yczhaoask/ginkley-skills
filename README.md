...
`scripts/reddit_fetch.py` — community discovery and post/comment collection through Reddit's public JSON endpoints. Standard library only, 2s between requests, backs off on 429.
